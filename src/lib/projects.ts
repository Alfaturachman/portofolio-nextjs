...
export const projects: Project[] = [
    ...
    },
    {
        ...
        privacy: 'Private',
        cardDesc:
            'Web platform integrated with the F-Scale device to monitor child growth and detect foot arch abnormalities.',
        desc: 'E-Growth is a digital growth monitoring platform integrated with the F-Scale pediatric measurement device to centralize patient data. The platform provides digital monitoring and visualization of child growth parameters and foot-arch analysis for early detection of flat foot and cavus foot. Field implementation and testing were carried out at TK Ainun Habibie and local community health posts (Posyandu), enabling digital growth and foot-structure monitoring for approximately 20 children.',
        problem:
            'Child growth and foot-structure data at health posts were recorded manually, making early detection of growth issues and foot arch abnormalities difficult.',
        solution:
    ...
    },
    {
        ...
        privacy: 'Private',
        cardDesc:
            'AI-assisted pre-diagnostic screening assistant for elderly health posts, a PIMNAS Finalist and EPICS in IEEE awardee.',
        desc: 'STEDI is a pre-diagnostic screening assistant for elderly health posts, combining a digital stethoscope that records lung sounds with AI-based analysis using deep learning models to help screen and diagnose lung conditions more quickly and accurately. As part of a team, the innovation was advanced to the National Finals of the 38th Pekan Ilmiah Mahasiswa Nasional (PIMNAS) under the Student Creativity Program for Innovative Works (PKM-KI), and scaled to an international level to secure a US$3,150 humanitarian technology grant from EPICS in IEEE (Jon C. Taenzer Memorial Fund). The STEDI Monitor Box physical device was also officially registered as a co-inventor in the Industrial Design Intellectual Property Rights (HKI).',
        problem:
            'Elderly health posts lacked an AI-assisted pre-diagnostic screening tool, and lung disease assessment still depended heavily on specialist interpretation of recorded sounds, which is time-consuming and subjective.',
        solution:
            'Developed STEDI as a pre-diagnostic screening assistant for elderly health posts, recording lung sounds through a digital stethoscope and analyzing them with a deep learning model, supported by the STEDI Monitor Box physical device.',
        outcome:
            'Advanced to the National Finals of PIMNAS 2025 (PKM-KI), secured a US$3,150 humanitarian technology grant from EPICS in IEEE, earned Industrial Design IPR (HKI) registration for the STEDI Monitor Box, and delivered AI-assisted analysis to support screening and diagnosis.',
        role: 'AI & Backend Developer',
        year: '2025',
        websiteType: 'AI Web App',
        sector: 'Healthcare',
        tags: ['Python', 'Django', 'Keras', 'Firebase', 'IoT', 'Machine Learning'],
        demo: '#',
